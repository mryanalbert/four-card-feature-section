...
export default function App() {
  return (
    <div className="min-h-screen p-12 flex justify-center items-center max-[700px]:py-6 px-2.5">
      <div>
        ...
        <div className="card-container grid grid-cols-3 gap-7 grid-rows-4 mt-11 max-w-[1000px] mx-auto max-[700px]:grid-cols-1 max-[700px]:max-w-[350px]">
          <Card
